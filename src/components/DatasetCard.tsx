  ...
  const handlePurchase = async () => {
    if (!connectedWallet) {
      setToast({
        ...
        message: "Please connect your wallet first to purchase dataset access.",
      });
      return;
    }
    ...
    try {
      ...
      setToast({
        ...
        message:
          error.message || "An unexpected error occurred during the purchase.",
      });
    } finally {
      setPurchasing(false);
    }
        ...
        <div className="p-6">
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500">
                by {dataset.contributor.slice(0, 6)}...
                {dataset.contributor.slice(-4)}
              </p>
            </div>
            {dataset.verified && (
          ...
          <p className="text-gray-600 text-sm mb-4">
            {isExpanded
              ...
              : truncateDescription(dataset.metadata.description)}
          ...
          <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
            <div>
              ...
              <div
                className={`inline-block px-2 py-1 rounded-full text-xs font-medium ml-2 ${getQualityColor(dataset.qualityScore)}`}
              >
          ...
          <div className="flex items-center justify-between mb-4 p-3 bg-gray-50 rounded-lg">
            ...
            <div className="text-right">
              ...
              <div className="font-semibold">{dataset.price} FIL</div>
            </div>
          </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-700">Filecoin + IPFS</span>
                </div>
              </div>
            </div>
          )}
